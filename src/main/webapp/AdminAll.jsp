...
<div class="main">
    <p style="color: #DDA0DD">当前位置：管理员主页</p>
...
<div style="text-align:center">
    <input type="button" value="查看部门信息" onclick="window.location.href='AdminAllDept.jsp'"><br>
</div>
<form name="formForSearchStaff" action="searchForAdmin.jsp">
    <div style="text-align:center">
        <input name="StaffNameForSearchForAdmin" type="text" value="<%=request.getParameter("StaffNameForSearchForAdmin")==null?"":request.getParameter("StaffNameForSearchForAdmin")%>">
