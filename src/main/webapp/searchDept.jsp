...
<div class="main">
    <p style="color: #DDA0DD">当前位置：员工主页/所有部门/搜索结果</p>
    ...
    <table class=table11_7>
        ...
        <%
            ...
            List<Dept> list = deptService.searchForOthers(request.getParameter("DeptNameForSearch"));
            for(Dept dept:list){%>
        <tr>
...
<div style="text-align:center">
    <input type="button" value="返回" onclick="window.location.href='AllDept.jsp'">
</div>
</body>
</html>
