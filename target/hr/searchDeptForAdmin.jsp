...
<div class="main">
    <p style="color: #DDA0DD">当前位置：管理员主页/所有部门/搜索结果</p>
    ...
    <table class=table11_7>
        ...
        <%
            ...
            List<Dept> list = deptService.searchForAdmin(request.getParameter("DeptNameForSearchForAdmin"));
            for (Dept dept : list) {%>
        <tr>
            <td><%=dept.getDeptName()%>
            </td>
...
<div style="text-align:center">
    <input type="button" value="返回" onclick="window.location.href='AdminAllDept.jsp'">
</div>
</body>
</html>
