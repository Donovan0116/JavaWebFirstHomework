...
<%@ page import="pers.Donovan.hr.service.StaffServiceImpl" %>
...
<div class="main">
    <p style="color: #DDA0DD">当前位置：员工主页/搜索结果</p>
    ...
    <table class=table11_7>
        ...
        <%
            ...
            List<Staff> list = staffService.searchForOthers(request.getParameter("StaffNameForSearch"));
...
<div style="text-align:center">
    <input type="button" value="返回" onclick="window.location.href='All.jsp'">
</div>
</body>
</html>
