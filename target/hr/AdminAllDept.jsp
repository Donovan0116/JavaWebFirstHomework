...
<div class="main">
    <p style="color: #DDA0DD">当前位置：管理员主页/所有部门</p>
    ...
    <table class=table11_7>
        ...
        <%
            ...
            List<Dept> list = deptService.showForAdmin();
            for (Dept dept : list) {%>
        <tr>
            <td><%=dept.getDeptName()%>
            </td>
...
<div style="text-align:center">
    <input type="button" value="返回" onclick="window.location.href='AdminAll.jsp'">
</div>
<form name="formForSearchStaff" action="searchDeptForAdmin.jsp">
    <div style="text-align:center">
        <input name="DeptNameForSearchForAdmin" type="text" value="<%=request.getParameter("DeptNameForSearchForAdmin")==null?"":request.getParameter("DeptNameForSearchForAdmin")%>">
